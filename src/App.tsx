...
import { Mail, Phone, MapPin, X, Menu } from 'lucide-react'
...
function App() {
  ...
  // Fermer le menu automatiquement lors d'un changement de page
  useEffect(() => {
    setIsMenuOpen(false)
  }, [location.pathname])
                  ...
                  <div className="flex flex-col gap-6">
                    ...
                    <div className="mt-12 pt-12 border-t border-gray-100">
                      ...
                      <div className="flex gap-4">
                        <a href="https://instagram.com/tripzone_oujda" target="_blank" rel="noopener noreferrer" className="w-14 h-14 bg-gray-50 rounded-2xl flex items-center justify-center text-gray-400 hover:text-primary transition-colors">
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-12 lg:gap-24 relative z-10">
                <div className="col-span-1 md:col-span-2">
                  <Link to="/" className="mb-8 block group">
                    <img src="/logo.png" alt="TripZone Logo" className="h-20 w-auto object-contain brightness-0 invert" />
                  </Link>
                  ...
                  <div className="flex gap-6 mt-10">
                    <a href="https://instagram.com/tripzone_oujda" target="_blank" rel="noopener noreferrer" className="w-12 h-12 bg-white/5 rounded-2xl flex items-center justify-center hover:bg-[#E4405F] transition-all group">
                      <svg className="w-5 h-5 fill-white" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        <path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zm0-2.163c-3.259 0-3.667.014-4.947.072-4.358.2-6.78 2.618-6.98 6.98-.059 1.281-.073 1.689-.073 4.948 0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98 1.281.058 1.689.072 4.948.072 3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98-1.281-.059-1.69-.073-4.949-.073zm0 5.838c-3.403 0-6.162 2.759-6.162 6.162s2.759 6.163 6.162 6.163 6.162-2.759 6.162-6.163c0-3.403-2.759-6.162-6.162-6.162zm0 10.162c-2.209 0-4-1.79-4-4s1.791-4 4-4 4 1.791 4 4-1.791 4-4 4zm6.406-11.845c-.796 0-1.441.645-1.441 1.44s.645 1.44 1.441 1.44c.795 0 1.439-.645 1.439-1.44s-.644-1.44-1.439-1.44z"/>
                      </svg>
                    </a>
                    <a href="https://wa.me/212701730174" target="_blank" rel="noopener noreferrer" className="w-12 h-12 bg-white/5 rounded-2xl flex items-center justify-center hover:bg-[#25D366] transition-all group">
                      <svg className="w-5 h-5 fill-white" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                <div>
                  ...
                  <ul className="space-y-4 text-gray-400 text-sm font-medium">
                    <li className="flex items-center gap-2"><MapPin className="w-4 h-4 text-primary" /> Oujda, Maroc</li>
                    <li className="flex items-center gap-2"><Phone className="w-4 h-4 text-primary" /> +212 7 01 73 01 74</li>
                    <li className="flex items-center gap-2"><Mail className="w-4 h-4 text-primary" /> contact@tripzone.ma</li>
                  </ul>
                </div>
              </div>

              <div className="mt-24 pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-4 text-gray-500 text-xs font-medium">
                <p>© 2026 TripZone. Tous droits réservés.</p>
                <p className="flex items-center gap-1">Développé avec <span className="text-red-500">❤️</span> pour l'Oriental.</p>
              </div>
            </div>
          </footer>
        } />
