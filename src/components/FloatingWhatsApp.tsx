...
export const FloatingWhatsApp = () => {
  ...
  return (
    <div ref={containerRef} className="fixed bottom-8 right-8 z-[90] flex items-center gap-4">
      ...
      <motion.a
        ...
        whileTap={{ scale: 0.9 }}
        className="w-14 h-14 bg-[#25D366] rounded-full flex items-center justify-center shadow-[0_8px_32px_rgba(37,211,102,0.3)] group relative shrink-0"
      >
